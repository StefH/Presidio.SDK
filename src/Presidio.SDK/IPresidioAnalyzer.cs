...
public interface IPresidioAnalyzer
{
    ...
    [Post("/analyze")]
    Task<RecognizerResultWithAnalysisExplanation[]> AnalyzeAsync([Body] AnalyzeRequest request);
    ...
    [Get("/recognizers")]
    Task<string[]> GetRecognizersAsync([Query] string language = "en");
    ...
    Task<string[]> GetSupportedEntitiesAsync([Query] string language = "en");
}